...
public final class SlimefunItems {
    ...
    // 别删
    public static final SlimefunItemStack CRAFTER_SMART_PORT = new SlimefunItemStack("CRAFTER_SMART_PORT", Material.LIME_STAINED_GLASS, "&a智慧合成機互動介面", "", "&5可以根據合成表材料數量分配輸入數量", "&5並擁有指定輸出欄");
